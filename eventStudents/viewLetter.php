...
<body>
    <header>
        ...
        <div class="menu">
            <ul>
                <li><a href="postEvent.php" class="filter">Book a Visit</a></li>
                <li><a href="getEvents.php" class="filter active">Completed Visits</a></li>
            </ul>
        </div>
        <div class="buttons">
    ...
    <div id="section" style="padding-bottom:50px;">
        <div class="letter">
            <div class="body">
                ...
                <p>
                    This is a letter verifying that <b><?php echo $eventHost; ?></b> has permission to <b><?php echo $eventTitle; ?></b> at 
